...
class EventType(enum.StrEnum):
    ...
    SHAREHOLDING_UPDATE = "SHAREHOLDING_UPDATE"
    MF_HOLDING_UPDATE = "MF_HOLDING_UPDATE"
    IV_UPDATE = "IV_UPDATE"
    ...
    # Corporate calendar / cross-exchange
    CORPORATE_ACTION = "CORPORATE_ACTION"
    BOARD_MEETING = "BOARD_MEETING"
    EVENT_CALENDAR = "EVENT_CALENDAR"
    PARTICIPANT_OI_UPDATE = "PARTICIPANT_OI_UPDATE"
